...
class CreateAliasRequest extends AbstractRequest
{
    ...
    const TEST = "https://e-payment.postfinance.ch/ncol/test/alias_gateway_utf8.asp";
    const PRODUCTION = "https://e-payment.postfinance.ch/ncol/prod/alias_gateway_utf8.asp";
